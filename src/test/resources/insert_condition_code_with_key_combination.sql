INSERT INTO condition_codes (condition_code) VALUES ('ZPTR');
SET @temp_id = (SELECT id FROM condition_codes WHERE condition_code = 'ZPTR');
...
INSERT INTO condition_codes (condition_code) VALUES ('ZR05');
SET @temp_id = (SELECT id FROM condition_codes WHERE condition_code = 'ZR05');
...
INSERT INTO condition_codes (condition_code) VALUES ('ZR02');
SET @temp_id = (SELECT id FROM condition_codes WHERE condition_code = 'ZR02');
...
INSERT INTO condition_codes (condition_code) VALUES ('ZPRK');
SET @temp_id = (SELECT id FROM condition_codes WHERE condition_code = 'ZPRK');
...
INSERT INTO condition_codes (condition_code) VALUES ('ZH00');
SET @temp_id = (SELECT id FROM condition_codes WHERE condition_code = 'ZH00');
...
INSERT INTO condition_codes (condition_code) VALUES ('ZH02');
SET @temp_id = (SELECT id FROM condition_codes WHERE condition_code = 'ZH02');
...
INSERT INTO condition_codes (condition_code) VALUES ('ZH03');
SET @temp_id = (SELECT id FROM condition_codes WHERE condition_code = 'ZH03');
...
INSERT INTO condition_codes (condition_code) VALUES ('ZGEB');
SET @temp_id = (SELECT id FROM condition_codes WHERE condition_code = 'ZGEB');
...
INSERT INTO condition_codes (condition_code) VALUES ('ZBEH');
SET @temp_id = (SELECT id FROM condition_codes WHERE condition_code = 'ZBEH');
...
INSERT INTO condition_codes (condition_code) VALUES ('ZMIL');
SET @temp_id = (SELECT id FROM condition_codes WHERE condition_code = 'ZMIL');
