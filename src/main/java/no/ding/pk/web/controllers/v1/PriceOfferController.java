...
public class PriceOfferController {
    ...
    public PriceOffer save(@PathVariable("id") Long id, @RequestBody String priceOffer) throws JsonMappingException, JsonProcessingException {
        ...
        PriceOffer current = result.get();

        ObjectReader objectReader = objectMapper.readerForUpdating(current);
        PriceOffer updatedOffer = objectReader.readValue(priceOffer);
